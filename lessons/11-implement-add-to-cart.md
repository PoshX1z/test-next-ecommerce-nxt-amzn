...
8. components/shared/product/add-to-cart.tsx (Doesn't work on my project)
...
(**Alternative Version**) 9. components/shared/product/add-to-cart.tsx(Use sonner that work on my project or you can use npx shadcn@2.1.8 add toast instead)
